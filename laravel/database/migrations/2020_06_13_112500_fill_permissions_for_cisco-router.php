...
class FillPermissionsForCiscoRouter extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCiscoRouter constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.cisco-router',
            'admin.cisco-router.index',
            'admin.cisco-router.create',
            'admin.cisco-router.show',
            'admin.cisco-router.edit',
            'admin.cisco-router.delete',
            'admin.cisco-router.bulk-delete',
        ]);
